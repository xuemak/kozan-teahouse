    ...
    <div className="grid grid-cols-4 gap-6 p-50">
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
        ...
        <div className="px-3 pb-4 pt-4 bg-orange-100">
          ...
          <p className="text-stone-500 text-base text-center font-light text-base p-2 w-50 h-30">
            Black milk tea made with non-dairy creamer, sweetened and drizzled
            with caramelized brown sugar.
          </p>
          <p className="text-gray-700 text-base text-center pt-6">$6.25</p>
        </div>
      </div>
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
        <Image
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
        ...
        <div className="px-3 pb-4 pt-4 bg-orange-100">
          ...
          <p className="text-stone-500 text-base text-center font-light text-base p-2 w-50 h-30">
            Green tea brewed with a slightly floral aroma made with our
            non-dairy creamer house milk.
          </p>
          <p className="text-gray-700 text-base text-center pt-6">$6.25</p>
        </div>
      </div>
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
        ...
        <div className="px-3 pb-4 pt-4 bg-orange-100">
          ...
          <p className="text-stone-500 text-base text-center font-light text-base p-2 w-50 h-30">
            Our strongly-brewed Thai milk tea mixed with our non-dairy house
            milk is a classic favorite.
          </p>
          <p className="text-gray-700 text-base text-center pt-6">$6.25</p>
        </div>
      </div>
